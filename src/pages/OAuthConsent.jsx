...
// clients here (see your server's MCP config `consent_path`) with an opaque
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        // Gate on the server's auth result, NOT a client-side SDK check:
        // the client-side check runs the bearer path, so a cookie-only session (platform
